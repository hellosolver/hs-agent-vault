...
8.  **Token Economy Lock**: Keep handovers short and actionable. Use targeted search, avoid repeated history, avoid repeated completed tasks, avoid full-file dumps, summarize long logs, and ask before expensive deep scans or rewrites.
